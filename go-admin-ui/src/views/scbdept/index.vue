...
<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="scbdeptList" @selection-change="handleSelectionChange">
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                            ...
                            <el-form-item label="" prop="deptPath">
                                <el-input v-model="form.deptPath" placeholder=""
                                              />
                            </el-form-item>
                            ...
                            <el-form-item label="" prop="leader">
                                <el-input v-model="form.leader" placeholder=""
                                              />
                            </el-form-item>
...
<script>
    import {addScbDept, delScbDept, getScbDept, listScbDept, updateScbDept} from '@/api/scbdept'
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                this.loading = true
                listScbDept(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                        this.scbdeptList = response.data.list
            ...
            handleUpdate(row) {
                ...
                const deptId =
                row.deptId || this.ids
                getScbDept(deptId).then(response => {
