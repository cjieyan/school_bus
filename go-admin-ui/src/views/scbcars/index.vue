    ...
    <div class="app-container">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
            <el-form-item label="车牌编号" prop="carNumber">
                        <el-input v-model="queryParams.carNumber" placeholder="请输入车牌编号" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="车牌号" prop="carNo">
                        <el-input v-model="queryParams.carNo" placeholder="请输入车牌号" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="司机" prop="driver">
                        <el-input v-model="queryParams.driver" placeholder="请输入司机" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
        ...
        <el-table v-loading="loading" :data="scbcarsList" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55" align="center"/><el-table-column label="" align="center" prop="id"
                                         :show-overflow-tooltip="true"/><el-table-column label="车牌编号" align="center" prop="carNumber"
                                         :show-overflow-tooltip="true"/><el-table-column label="车牌号" align="center" prop="carNo"
                                         :show-overflow-tooltip="true"/><el-table-column label="座位数" align="center" prop="seatsNum"
                                         :show-overflow-tooltip="true"/><el-table-column label="跟车员" align="center" prop="attendantId"
                                         :show-overflow-tooltip="true"/><el-table-column label="司机" align="center" prop="driver"
                                         :show-overflow-tooltip="true"/><el-table-column label="手机号" align="center" prop="phone"
                                         :show-overflow-tooltip="true"/><el-table-column label="所属部门" align="center" prop="dept"
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                            ...
                            <el-form-item label="车牌编号" prop="carNumber">
                                <el-input v-model="form.carNumber" placeholder="车牌编号"
                                              />
                            </el-form-item>
                            <el-form-item label="车牌号" prop="carNo">
                            ...
                            <el-form-item label="座位数" prop="seatsNum">
                                <el-input v-model="form.seatsNum" placeholder="座位数"
                                              />
                            </el-form-item>
                            <el-form-item label="跟车员" prop="attendantId">
                                <el-input v-model="form.attendantId" placeholder="跟车员"
                                              />
                            </el-form-item>
                            <el-form-item label="司机" prop="driver">
                                <el-input v-model="form.driver" placeholder="司机"
                                              />
                            </el-form-item>
                            <el-form-item label="手机号" prop="phone">
                            ...
                            <el-form-item label="所属部门" prop="dept">
                                <el-input v-model="form.dept" placeholder="所属部门"
                                              />
                            </el-form-item>
                            <el-form-item label="0正常 1已删除" prop="isDelete">
                                <el-input v-model="form.isDelete" placeholder="0正常 1已删除"
                                              />
                            </el-form-item>
            </el-form>
