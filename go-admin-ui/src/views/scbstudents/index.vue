    ...
    <div class="app-container">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
            <el-form-item label="" prop="id">
                ...
                <el-form-item label="学号" prop="number">
                        <el-input v-model="queryParams.number" placeholder="请输入学号" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                ...
                <el-form-item label="站点id" prop="siteId">
                        <el-input v-model="queryParams.siteId" placeholder="请输入站点id" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="车辆id" prop="carId">
                        <el-input v-model="queryParams.carId" placeholder="请输入车辆id" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="家长电话" prop="parentPhone">
                        <el-input v-model="queryParams.parentPhone" placeholder="请输入家长电话" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="图片" prop="picture">
                        <el-input v-model="queryParams.picture" placeholder="请输入图片" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="创建时间" prop="createdAt">
                        <el-input v-model="queryParams.createdAt" placeholder="请输入创建时间" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
                <el-form-item label="更新时间" prop="updatedAt">
                        <el-input v-model="queryParams.updatedAt" placeholder="请输入更新时间" clearable
                                      size="small" @keyup.enter.native="handleQuery"/>
                    </el-form-item>
        ...
        <el-table v-loading="loading" :data="scbstudentsList" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="55" align="center"/><el-table-column label="" align="center" prop="id"
                                         ...
                                         :show-overflow-tooltip="true"/><el-table-column label="线路id" align="center" prop="lineId"
                                         :show-overflow-tooltip="true"/><el-table-column label="站点名称" align="center" prop="siteName"
                                         :show-overflow-tooltip="true"/><el-table-column label="站点id" align="center" prop="siteId"
                                         :show-overflow-tooltip="true"/><el-table-column label="车辆id" align="center" prop="carId"
                                         :show-overflow-tooltip="true"/><el-table-column label="家长电话" align="center" prop="parentPhone"
                                         :show-overflow-tooltip="true"/><el-table-column label="图片" align="center" prop="picture"
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                            ...
                            <el-form-item label="线路id" prop="lineId">
                                <el-input v-model="form.lineId" placeholder="线路id"
                                              />
                            </el-form-item>
                            <el-form-item label="站点名称" prop="siteName">
                            ...
                            <el-form-item label="站点id" prop="siteId">
                                <el-input v-model="form.siteId" placeholder="站点id"
                                              />
                            </el-form-item>
                            <el-form-item label="车辆id" prop="carId">
                                <el-input v-model="form.carId" placeholder="车辆id"
                                              />
                            </el-form-item>
                            <el-form-item label="家长电话" prop="parentPhone">
                                <el-input v-model="form.parentPhone" placeholder="家长电话"
                                              />
                            </el-form-item>
                            <el-form-item label="图片" prop="picture">
                                <el-input v-model="form.picture" placeholder="图片"
                                              />
                            </el-form-item>
                            <el-form-item label="0未删除 1已删除" prop="isDeleted">
