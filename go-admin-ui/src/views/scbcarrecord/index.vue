...
<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button
                        v-permisaction="['scbcarrecord:scbcarrecord:add']"
                        type="primary"
                        icon="el-icon-plus"
                        size="mini"
                        @click="handleAdd"
            ...
            <el-col :span="1.5">
                <el-button
                        v-permisaction="['scbcarrecord:scbcarrecord:edit']"
                        type="success"
                        icon="el-icon-edit"
                        size="mini"
                        :disabled="single"
            ...
            <el-col :span="1.5">
                <el-button
                        v-permisaction="['scbcarrecord:scbcarrecord:remove']"
                        type="danger"
                        icon="el-icon-delete"
                        size="mini"
                        :disabled="multiple"
        ...
        <el-table v-loading="loading" :data="scbcarrecordList" @selection-change="handleSelectionChange">
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                            ...
                            <el-form-item label="线路id" prop="siteId">
                                <el-input v-model="form.siteId" placeholder="线路id"
                                              />
                            </el-form-item>
            </el-form>
